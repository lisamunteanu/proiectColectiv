...
@Embeddable
public class MovieHistoryId implements Serializable {
    ...
    public MovieHistoryId() {
    }

    public MovieHistoryId(RepoUser user, Movie movie) {
        this.user = user;
        this.movie = movie;
    }
    ...
    public boolean equals(Object o) {
        ...
        MovieHistoryId that = (MovieHistoryId) o;
